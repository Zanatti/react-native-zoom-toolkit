...
const SnapbackZoom = ({
  ...
  const pan = Gesture.Pan().withTestId('pan').enabled(gesturesEnabled).maxPointers(1).minDistance(50) // Require more movement before activating
  ...
  return /*#__PURE__*/React.createElement(GestureDetector, {
    gesture: Gesture.Race(pinch, pan, composedTapGesture)
